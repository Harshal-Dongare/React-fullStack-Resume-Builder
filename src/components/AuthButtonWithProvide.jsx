...
const AuthButtonWithProvide = ({ Icon, label, provider }) => {
    const googleAuthProvider = new GoogleAuthProvider();
    const githubAuthProvider = new GithubAuthProvider();

    /**
     * Handles the button click event for each auth provider. Switches on the
     * provider and executes a provided function.
...
export default AuthButtonWithProvide;
